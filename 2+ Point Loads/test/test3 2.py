...
class Beam:
    ...
    # dibujar solicitado
    def draw_beam_elements(self, solicitado, ax=None):   # solicitado = ['beam', 'supports', 'loads', 'reactions']
        self.reactions()
